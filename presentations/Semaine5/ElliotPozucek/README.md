# Elliot Pozucek - Proprety-Based Testing
...
Je vais parler du concept de **Proprety-Based Testing**, en quoi cette méthode de test **diffère des tests unitaires 'examples'**, puis je présenterais **Jqwik** avec un exemple pratique. 
